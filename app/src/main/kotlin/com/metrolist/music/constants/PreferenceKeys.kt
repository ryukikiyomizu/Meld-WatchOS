...
val VideoSongsUnhideMigrationKey = booleanPreferencesKey("videoSongsUnhideMigration")
...
val DoublePinchActionKey = stringPreferencesKey("doublePinchAction")
val WearBatterySaverKey = booleanPreferencesKey("wearBatterySaver")
val AutoSyncPolicyKey = stringPreferencesKey("autoSyncPolicy")
val OffloadToPhoneKey = booleanPreferencesKey("offloadSyncToPhone")
val SyncSkipCountKey = intPreferencesKey("syncSkipCount")
val SyncDeltaSkipKey = intPreferencesKey("syncDeltaSkipCount")
val SyncAddedKey = intPreferencesKey("syncDeltaAdded")
val SyncRemovedKey = intPreferencesKey("syncDeltaRemoved")
val MinimalModeKey = booleanPreferencesKey("minimalMode")
val AudioOutputKey = stringPreferencesKey("minimalAudioOutput")
